...
#cp "$ZKSYNC_LIB_DIR"/target/aarch64-linux-android/release/${LIB_NAME} "${ANDROID_JNI_ROOT_checker}"/arm64-v8a/${LIB_NAME}
#cp "$ZKSYNC_LIB_DIR"/target/armv7-linux-androideabi/release/${LIB_NAME} "${ANDROID_JNI_ROOT_checker}"/armeabi-v7a/${LIB_NAME}
#cp "$ZKSYNC_LIB_DIR"/target/i686-linux-android/release/${LIB_NAME} "${ANDROID_JNI_ROOT_checker}"/x86/${LIB_NAME}
#cp "$ZKSYNC_LIB_DIR"/target/x86_64-linux-android/release/${LIB_NAME} "${ANDROID_JNI_ROOT_checker}"/x86_64/${LIB_NAME}
